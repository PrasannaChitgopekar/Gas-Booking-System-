...
function Complaints() {
  ...
  return (
    ...
    <form onSubmit={handleSubmitComplaint}>
        ...
        <textarea rows={10} cols = {10} type="text" name="complaint_description" value={credentials.complaint_description}  onChange={onChange} placeholder="Description" required ></textarea>
        <button type="submit" className="button" style={{padding: "8px 100px",opacity:"0.9"}}>submit</button>
    </form>
    </div>
    <br/>
    <div style={{fontFamily:"sans-serif",textAlign:"left",textAlign:"center",margin:" 0vh 15vw"}}>
